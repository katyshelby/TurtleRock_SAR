...
# Prepare data for SAR analysis (v1: grouped tag code analysis)
...
# Prepare data for SAR analysis (v2: individual tag code analysis)
...
# Run analysis (v1: by groups of tag codes)
